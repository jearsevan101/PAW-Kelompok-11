...
export default function Dashboard() {
  ...
  return (
    ...
    <main className="container min-h-screen pt-20 bg-[#F6F7F9] flex flex-col sm:flex-row justify-between px-4 sm:px-0">
      <div className="object-cover relative w-full sm:w-[750px] p-8 h-[screen] rounded-xl overflow-hidden bg-[#FFFFFF] ml-[24px] mb-[36px] mt-[36px]">
          <h2 className="font-bold text-[20px]">
            Recent Rental
          </h2>
      </div>
      <div className="object-cover relative w-full sm:w-[750px] p-8 h-[screen] rounded-xl overflow-hidden bg-[#FFFFFF] ml-[24px] mb-[36px] mt-[36px] mr-[20px]">
          <h2 className="font-bold text-[20px]">
            History Transcation
          </h2>
            {sewaList.map(sewa => (
